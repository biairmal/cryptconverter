...
import 'package:cryptconverter/source_code/vignere_code.dart';

class VignerePage extends StatefulWidget {
  @override
  _VignerePageState createState() => _VignerePageState();
}

class _VignerePageState extends State<VignerePage> {
  ...
  void _vignereCipher() {
    ...
    VigenereCipher convert = new VigenereCipher(shift);
